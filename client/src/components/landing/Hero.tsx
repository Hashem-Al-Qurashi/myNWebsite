...
import { WHATSAPP_URL, STUDY_PLAN_URL, STATS } from "@/lib/constants";
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            ...
            >
              {[
                { number: STATS.SUCCESS_RATE, label: "نسبة النجاح" },
                { number: STATS.SCORE_IMPROVEMENT, label: "معدل تحسن الدرجة" },
                { number: STATS.SUCCESSFUL_STUDENTS, label: "طالب ناجح" },
              ].map((stat, i) => (
                <div
                  key={i}
                  className="text-center bg-background/60 dark:bg-card/30 backdrop-blur-sm rounded-2xl p-6 border border-primary/10"
                >
