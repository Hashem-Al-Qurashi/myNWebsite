  ...
  const renderInstagramEmbed = (embedUrl: string) => (
    <div className="w-full max-w-md mx-auto">
      ...
      <p className="text-center text-gray-500 p-4">
        If the reel doesn't load, <a href={embedUrl} target="_blank" rel="noopener noreferrer" className="text-blue-500">click here</a> to view on Instagram.
      </p>
    </div>
  );
  ...
  const renderTikTokEmbed = (embedUrl: string) => {
    ...
    return (
      <div className="w-full max-w-md mx-auto">
        ...
        >
          <section>
            <a target="_blank" rel="noopener noreferrer" href={`https://www.tiktok.com/@${username}?refer=embed`}>@{username}</a>
          </section>
        </blockquote>
        <p className="text-center text-gray-500 p-4">
          If the video doesn't load, <a href={embedUrl} target="_blank" rel="noopener noreferrer" className="text-blue-500">click here</a> to view on TikTok.
        </p>
      </div>
    );
  };
