...
export default function Testimonials() {
  ...
  const testimonialTexts = [
    "شكراً للأستاذ هاشم على الدورة الرائعة",
    "تحسنت درجتي من 5.5 إلى 7 في شهرين فقط!",
    "أفضل دورة ايلتس جربتها",
    "الشرح واضح والمتابعة ممتازة",
    "نصائح عملية ساعدتني كثيراً",
    "دورة تستحق كل ريال دفعته"
  ];
            ...
            {testimonialImages.map((image, index) => (
              <CarouselItem key={index} className={`${isMobile ? 'basis-full' : 'basis-1/2 md:basis-1/3 lg:basis-1/4'}`}>
                <motion.div
                  ...
                  className="testimonial-card bg-background dark:bg-card rounded-lg shadow-md overflow-hidden relative z-30 h-full hardware-accelerated will-change-transform reduce-motion-mobile"
                >
