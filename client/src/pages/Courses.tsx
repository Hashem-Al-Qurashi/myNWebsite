      ...
      <section className="py-32 bg-gradient-to-b from-background via-primary/5 to-muted/30 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="mb-20 max-w-6xl mx-auto overflow-hidden rounded-3xl bg-gradient-to-r from-primary/20 via-card/80 to-primary/20 border-2 border-primary/30 shadow-2xl shadow-primary/10 backdrop-blur-lg p-10"
          >
            <motion.div
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-card/70 backdrop-blur-sm rounded-xl p-8 border border-primary/10 hover:border-primary/30 transition-all shadow-xl hover:shadow-primary/20"
            >
              ...
              <h3 className="text-2xl font-semibold mb-4 rtl text-center">دورة مخصصة وشخصية</h3>
              <p className="text-lg text-muted-foreground rtl text-center">
                بكل بساطة، دورتي خاصة ومباشرة، مو دورة معلبة للجميع! لأنك مميز وتستاهل اهتمام كامل، أكون معاك بتركيزي الكامل.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <h3 className="text-2xl font-semibold mb-4 rtl text-center">دعم متواصل ومباشر</h3>
              <p className="text-lg text-muted-foreground rtl text-center">
            ...
            >
              ...
              <h3 className="text-2xl font-semibold mb-4 rtl text-center">فعالية مضمونة</h3>
              <p className="text-lg text-muted-foreground rtl text-center">
